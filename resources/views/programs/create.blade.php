                    ...
                    <form action="{{ route('programs.store') }}" method="POST" class="sm:px-24">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="description" 
                                      id="description" 
                                      rows="5"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('description') @enderror"
