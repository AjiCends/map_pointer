<x-app-layout>
    ...
    <div class="py-2 sm:py-12" style="height: calc(100vh - 64px);">
                ...
                <div class="flex flex-col lg:flex-row gap-6 mb-5 h-full">
                    ...
                    <div class="lg:basis-2/3 bg-slate-100 border shadow-lg p-2 rounded-lg sm:rounded-xl">
                        <div class="w-full aspect-square lg:h-full lg:aspect-auto">
                            <x-map-dashboard :coordinates="$programs->flatMap(
                    ...
                    <!-- Grid Program -->
                    <div class="lg:basis-1/3 relative" id="program_section">
                        <div id="programs-container"
                            ...
                            <div class="flex flex-col px-3">
                                <div
                                    class="flex justify-center items-center gap-2 bg-gray-100 p-2 rounded-lg mb-4 border">
