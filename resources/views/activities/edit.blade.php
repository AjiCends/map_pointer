                    ...
                    <form action="{{ route('activities.update', $activity) }}" method="POST" class="sm:px-24">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" name="order_num" id="order_num"
                                value="{{ old('order_num', $activity->order_num ?? '') }}"
                                class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            @error('order_num')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-6">
                            ...
                            <label class="inline-flex items-center cursor-pointer">
                                <!-- Checkbox -->
                                <input name="is_hide" type="checkbox" value="1" class="sr-only peer"
                                    {{ $activity->is_hide == 1 ? 'checked' : '' }}>
                                ...
                                <div
                                    class="relative w-11 h-6 bg-gray-200 rounded-full 
                                           ...
                                           dark:border-gray-600 dark:peer-checked:bg-blue-600">
                                </div>
                            </label>
